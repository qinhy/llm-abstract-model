...
class LLMsStore(BasicStore):
    ...
    def add_new_mt5account(self,account_id:int,password:str,account_serverstr:str) -> Model4LLMs.MT5Account:
        return self.add_new_obj(Model4LLMs.MT5Account(account_id=account_id,password=password,
                                        account_serverstr=account_serverstr),id=f'MT5Account:{account_id}')
